...
% A Turing Machine is formally defined as follows:
% \begin{align}
% 	M = \parenset{Q, \Sigma, \Gamma, \delta, q_0, B, F}
% \end{align}
% where
% \begin{enumerate*}
% 	\item test
...
%
%
% \emph{Q} is the set of internal \emph{states} of the machine. \ilmath{\Sigma} is the finite input alphabet. \ilmath{\Gamma \supseteq \Sigma} is the finite tape alphabet excluding the left and right markers \ilmath{\triangleright}, \ilmath{\triangleleft \notin \Gamma} respectively. \ilmath{\delta} is the \emph{transition function} \ilmath{: (Q - \set{q_\text{acc}, q_\text{rej}}) \times }
