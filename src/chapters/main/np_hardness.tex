...
\begin{figure}[h]
	...
	\caption{
		A minimal Monotone 3CNF formula \ilmath{\varphi = \parens{b_1 \lor b_2 \lor b_3}} reduced to a robot motion planning problem. The dark red graphics show how the robots would be offset were it an all-negative clause. Disks represent robots while crosses represent their target positions. The circles highlight the variable-literal couplings and literal-clause couplings: a mismatched assignment of \ilmath{b_{j_k}} w.r.t. \ilmath{l_{i,k}} cascades into \ilmath{l_{i,k}} blocking the path of \ilmath{c_i}.
