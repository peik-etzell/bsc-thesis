\section{Alternative metrics to makespan}
...
% Simultaneously optimizing \emph{any} pairing of the four metrics is not yet ruled out. The pairings \ilmath{\set{\parens{\mono{M,\ MD}},\ \parens{\mono{TAT,\ TD}}}} are still left: proving that these cannot always be simultaneously optimized for would imply \cref{} holds for any pairing \ilmath{\parens{f_1,\ f_2} \in \set{\mono{M, TAT, TD, MD}}^2}.
